...
Currently, you can sign up for the email list on the **[Hero Generator website](https://www.herogenerator.art)**. I set it up quickly just to allow me to get started. 

I will send emails with the latest news on the project, and you will also be the first to be able to try it once it is in a good enough state for a public beta release.
